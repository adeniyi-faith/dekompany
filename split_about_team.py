...
with open('about/team.php', 'r', encoding='utf-8') as f:
    content = f.read()
...
main_start = content.find('<!-- Team Hero -->')
...
with open('assets/css/about_team.css', 'w', encoding='utf-8') as f:
    f.write(css_content)

with open('assets/js/about_team.js', 'w', encoding='utf-8') as f:
    f.write(js_content)

with open('components/about/about_team_component.php', 'w', encoding='utf-8') as f:
    f.write(body_content.strip())

new_main_content = f"""<?php
$pageTitle = "Leadership & Experts";
$pageDesc = "Meet the minds behind De Kompany.";
include 'header.php';
?>

<link rel="stylesheet" href="/assets/css/about_team.css">

<?php require_once __DIR__ . '/../components/about/about_team_component.php'; ?>

<script src="/assets/js/about_team.js"></script>

<?php include 'footer.php'; ?>"""

with open('about/team.php', 'w', encoding='utf-8') as f:
