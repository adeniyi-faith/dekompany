    ...
    <div class="app-shell">
        <div class="app-container">
            ...
            <div class="bottom-area animate-in delay-2">
                <form id="chat-form" class="chat-input-wrapper rounded-full px-4 py-2 flex items-center gap-3 w-full" novalidate>
                    <i class="fa-solid fa-sparkles text-yellow-500/50 text-sm flex-shrink-0" aria-hidden="true"></i>
                    <label for="user-input" class="visually-hidden">Type your message</label>
                    <input type="text"
                           id="user-input"
                           placeholder="Type your message..."
                           class="bg-transparent border-none outline-none flex-grow text-white placeholder-gray-500 font-light"
                           autocomplete="off"
                           enterkeyhint="send"
                           maxlength="1200">
                    <button type="submit" id="send-btn" class="text-gray-400 hover:text-yellow-400 transition transform active:scale-90 p-2 touch-manipulation flex-shrink-0" aria-label="Send message">
                        <i class="fa-solid fa-paper-plane-top text-lg"></i>
                    </button>
                </form>
