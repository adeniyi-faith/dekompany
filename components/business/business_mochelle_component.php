            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:border-pink-200 hover:shadow-lg transition text-center group">
                    <div class="w-20 h-20 mx-auto bg-white rounded-full mb-4 shadow-sm p-1">
                         <img loading="lazy" src="https://placehold.co/200x200/1e3a8a/ffffff?text=DO" class="w-full h-full object-cover rounded-full grayscale group-hover:grayscale-0 transition">
                    </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:border-pink-200 hover:shadow-lg transition text-center group">
                    <div class="w-20 h-20 mx-auto bg-white rounded-full mb-4 shadow-sm p-1">
                         <img loading="lazy" src="https://placehold.co/200x200/1e3a8a/ffffff?text=ON" class="w-full h-full object-cover rounded-full grayscale group-hover:grayscale-0 transition">
                    </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:border-pink-200 hover:shadow-lg transition text-center group">
                     <div class="w-20 h-20 mx-auto bg-white rounded-full mb-4 shadow-sm p-1">
                         <img loading="lazy" src="https://placehold.co/200x200/1e3a8a/ffffff?text=FT" class="w-full h-full object-cover rounded-full grayscale group-hover:grayscale-0 transition">
                    </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 hover:border-pink-200 hover:shadow-lg transition text-center group">
                     <div class="w-20 h-20 mx-auto bg-white rounded-full mb-4 shadow-sm p-1">
                         <img loading="lazy" src="https://placehold.co/200x200/1e3a8a/ffffff?text=AP" class="w-full h-full object-cover rounded-full grayscale group-hover:grayscale-0 transition">
                    </div>
